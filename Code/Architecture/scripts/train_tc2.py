...
from futils import get_config
from futils.data import ArabDataset, text_mel_collate_fn
from futils.logging import TBLogger
from futils.training import batch_to_device, save_states
...
# datasets
train_dataset = ArabDataset(csv_file=config.train_labels, 
